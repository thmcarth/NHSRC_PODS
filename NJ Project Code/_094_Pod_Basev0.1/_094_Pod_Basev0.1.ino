...
unsigned long sendTimer = -525000; //timer to sendQuery every (minsToCheck) minutes
...
void sendStatus()
{
  ...
  sprintf(message,"%s%s",message,"\n");
  sprintf(message,"%s%s",message,"1=Change Unit 1 Mode");
  sprintf(message,"%s%s",message,"\n");
  sprintf(message,"%s%s",message,"2=Change Unit 1 State");
  sprintf(message,"%s%s",message,"\n");
  sprintf(message,"%s%s",message,"3=Change Unit 2 Mode");
  sprintf(message,"%s%s",message,"\n");
  sprintf(message,"%s%s",message,"4=Change Unit 2 State");
