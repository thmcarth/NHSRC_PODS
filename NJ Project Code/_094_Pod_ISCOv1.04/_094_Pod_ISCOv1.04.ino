...
//Version 1.04 - Added more comments 05/18/2018 - Tim McArthur
...
//Watchdog Library Used for Auto-restarting in case of code lockup
#include <Adafruit_SleepyDog.h>
//EEPROM library and address values for saving mode and auto sampling interval to memory
#include <EEPROM.h>
