...
void loop()
{
  ...
  { 
    ...
    //Serial.print("Millis before detach = ");Serial.println(millis());
    ...
    dataFile.print(flowRate);  // Print the integer part of the variable
    dataFile.print(",");
    dataFile.print(totalMilliLitres);
    dataFile.print(","); 
    dataFile.print(totalMilliLitres/1000.0);
    dataFile.print(",");
    dataFile.close();
    }
    ...
    //Serial.print("Millis after attach = ");Serial.println(millis());
    //unsigned long difference = after - before;
    //Serial.print("Millis elapsed = ");Serial.println(difference);
  }
}
